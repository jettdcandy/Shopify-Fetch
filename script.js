  ...
  chrome.tabs.query({ active: true, currentWindow: true }, ([currentTab]) => {
    ...
    const product = fetch(current_product_json);
      ...
      .then((json) => {
        ...
        //Reveal copy product_id button if fetch succesful
...
// Copy function for product-ID field

document.getElementById('copy').addEventListener("click", () => {

  //Create temp hidden textarea element

  let text_area =  document.createElement('textarea');

  //Select & insert temp textarea element before info-container div
  
  let info_container = document.querySelector('.info-container');
  document.body.insertBefore(text_area, info_container);

  //Set value of temp textarea element to current product ID
  
  text_area.value = document.getElementById("product-id").innerHTML;

  //Select content inside textarea element
  ...
  //Generate a notification Toast to confirm copy product ID to clipboard
